...
function buildProposalHtmlMX({
  ...
  const TYC_MX = [
    ...
    `Para los relojes checadores en modalidad renta: el servicio incluye mantención y reposición por falla técnica. Los equipos son propiedad de GeoVictoria y al término del servicio deben devolverse en ${ORG_MX.direccion}, ${ORG_MX.ciudad}. Si terminas el servicio con menos de 6 mensualidades de renta pagadas y conservas los equipos, se cobra el equivalente a 6 mensualidades de renta ($2,100 MXN por reloj checador).`,
