...
function buildProposalHtmlPE({
  ...
  const TYC_PE = [
    ...
    "Envío del reloj: incluido en alquiler; en venta es sin costo en Lima Metropolitana y tiene un valor fijo por equipo a provincia, indicado en esta cotización. Instalación: la auto-instalación no tiene costo; la visita técnica es opcional, se cotiza como pago único según la zona (Lima Metropolitana / ciudades intermedias / resto del país) y va incluida sin costo en alquiler dentro de Lima Metropolitana.",
    "Para los equipos en modalidad alquiler: el servicio incluye mantención y reposición por falla técnica; los equipos son propiedad de GeoVictoria y deben devolverse al término del servicio.",
